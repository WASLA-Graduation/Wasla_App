  ...
  static Route<dynamic>? onGenerateRoute(RouteSettings settigns) {
    switch (settigns.name) {
      ...
      case AppRoutes.reviewScreen:
        final int? reviewId = settigns.arguments as int?;
        return MaterialPageRoute(
          builder: (_) => ReviewsView(reviewId: reviewId),
        );
      ...
      case AppRoutes.allPostsScreen:
        return MaterialPageRoute(builder: (_) => AllPostsView());
      case AppRoutes.addPostsScreen:
        return MaterialPageRoute(builder: (_) => AddPostView());
      case AppRoutes.socialProfileScreen:
        final Map<String, dynamic> userData =
            settigns.arguments as Map<String, dynamic>;
        return MaterialPageRoute(
          builder: (_) => SocialProfileView(userData: userData),
        );

      case AppRoutes.reactionsScreen:
        final int postId = settigns.arguments as int;
        return MaterialPageRoute(builder: (_) => ReactionsView(postId: postId));
      case AppRoutes.driverCompleteInfoScreen:
        return MaterialPageRoute(builder: (_) => DriverInfoView());
      case AppRoutes.driverBottomNavBarScreen:
        return MaterialPageRoute(builder: (_) => DriverBottomNavBar());
      case AppRoutes.residentDriverScreen:
        return MaterialPageRoute(builder: (_) => ResidentDriverView());
