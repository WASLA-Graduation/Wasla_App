...
class GymAddUpdatePackageForm extends StatelessWidget {
  const GymAddUpdatePackageForm({super.key});
      ...
      child: ListView(
        children: [
          ...
          CustomTextFormField(
            ...
            keyboardTyp: TextInputType.number,
            onChanged: (value) {
              cubit.durationPackage = value.isEmpty ? 0 : int.parse(value);
            },
            validator: (value) => validateSimpleData(value, context),
            withBorder: true,
            fillColor: Colors.transparent,
