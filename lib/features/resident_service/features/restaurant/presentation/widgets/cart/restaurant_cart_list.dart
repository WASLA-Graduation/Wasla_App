...
import 'package:wasla/features/resident_service/features/restaurant/presentation/widgets/cart/restaurant_cart_list_item.dart';
      ...
      builder: (context, state) {
        ...
        return cart.isEmpty
            ...
            : ListView.separated(
                ...
                itemBuilder: (context, index) => RestaurantCartListItem(
                  item: cart[index],
