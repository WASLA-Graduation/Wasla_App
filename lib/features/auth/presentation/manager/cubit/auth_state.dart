...
final class AuthDriverCompleteInfoLoading extends AuthState {}

final class AuthDriverCompleteInfoSuccess extends AuthState {}

final class AuthDriverCompleteInfoFailure extends AuthState {
  final String errMsg;

  AuthDriverCompleteInfoFailure({required this.errMsg});
}
