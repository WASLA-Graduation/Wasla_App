...
class CustomChooseResturentImage extends StatelessWidget {
  const CustomChooseResturentImage({super.key});
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            cubit.resturentImage != null
                ? Image.asset(Assets.assetsImagesAccept, width: 22, height: 22)
                : Icon(
